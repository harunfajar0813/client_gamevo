...
class APubgGame extends StatefulWidget {
  @override
...
class _CourseInfoScreenState extends State<APubgGame> with TickerProviderStateMixin {
          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1.2,
                  child: Image.asset('assets/design_course/game_pubg.jpg'),
                ),
              ],
            ),
            Positioned(
